...
import { CheckCircle, Clock, AlertCircle, ListTodo, Layout, Users } from "lucide-react"
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Here's an overview of your tasks and boards</p>
      </div>
          ...
          <Card>
            <CardContent className="py-8">
              <div className="text-center">
                ...
                <Button onClick={() => navigate("/board-selection")}>Go to Board Selection</Button>
              </div>
            </CardContent>
          </Card>
        ) : (
      ...
      <div>
        <div className="flex justify-between items-center mb-4">
          ...
          <Button variant="outline" onClick={handleViewAllBoards}>
            View All
          </Button>
        </div>
          ...
          <Card>
            <CardContent className="py-8">
              <div className="text-center">
                ...
                <Button onClick={() => navigate("/board-selection")}>Create a Board</Button>
              </div>
            </CardContent>
          </Card>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {boards.slice(0, 3).map((board) => (
              <Card key={board.id} className="hover:shadow-md transition-shadow">
                ...
                <CardFooter>
                  <Button className="w-full" onClick={() => navigate(`/boards/${board.id}`)}>
                    Open Board
                  </Button>
                </CardFooter>
              </Card>
